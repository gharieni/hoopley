...
export declare class ConversationsClient {
    ...
    createCallMatcher(request: protos.google.cloud.dialogflow.v2.ICreateCallMatcherRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.ICallMatcher, protos.google.cloud.dialogflow.v2.ICreateCallMatcherRequest | undefined, {} | undefined]>;
    createCallMatcher(request: protos.google.cloud.dialogflow.v2.ICreateCallMatcherRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2.ICallMatcher, protos.google.cloud.dialogflow.v2.ICreateCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    createCallMatcher(request: protos.google.cloud.dialogflow.v2.ICreateCallMatcherRequest, callback: Callback<protos.google.cloud.dialogflow.v2.ICallMatcher, protos.google.cloud.dialogflow.v2.ICreateCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    deleteCallMatcher(request: protos.google.cloud.dialogflow.v2.IDeleteCallMatcherRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteCallMatcherRequest | undefined, {} | undefined]>;
    deleteCallMatcher(request: protos.google.cloud.dialogflow.v2.IDeleteCallMatcherRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    deleteCallMatcher(request: protos.google.cloud.dialogflow.v2.IDeleteCallMatcherRequest, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2.IDeleteCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    ...
    listCallMatchers(request: protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2.ICallMatcher[], protos.google.cloud.dialogflow.v2.IListCallMatchersRequest | null, protos.google.cloud.dialogflow.v2.IListCallMatchersResponse]>;
    listCallMatchers(request: protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, options: CallOptions, callback: PaginationCallback<protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, protos.google.cloud.dialogflow.v2.IListCallMatchersResponse | null | undefined, protos.google.cloud.dialogflow.v2.ICallMatcher>): void;
    listCallMatchers(request: protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, callback: PaginationCallback<protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, protos.google.cloud.dialogflow.v2.IListCallMatchersResponse | null | undefined, protos.google.cloud.dialogflow.v2.ICallMatcher>): void;
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
     *   The request object that will be sent.
     ...
     *   for more details and examples.
     */
    listCallMatchersStream(request?: protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, options?: CallOptions): Transform;
    /**
     ...
     * }
     */
    listCallMatchersAsync(request?: protos.google.cloud.dialogflow.v2.IListCallMatchersRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2.ICallMatcher>;
     ...
     * @returns {string} Resource name string.
     */
    projectConversationCallMatcherPath(project: string, conversation: string, callMatcher: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectConversationCallMatcherName(projectConversationCallMatcherName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the conversation.
     */
    matchConversationFromProjectConversationCallMatcherName(projectConversationCallMatcherName: string): string | number;
    /**
     ...
     */
    matchCallMatcherFromProjectConversationCallMatcherName(projectConversationCallMatcherName: string): string | number;
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectLocationConversationCallMatcherPath(project: string, location: string, conversation: string, callMatcher: string): string;
    /**
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the conversation.
     */
    matchConversationFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName: string): string | number;
    /**
     ...
     * @returns {string} A string representing the call_matcher.
     */
    matchCallMatcherFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName: string): string | number;
    /**
