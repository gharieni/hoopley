...
class ConversationsClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            ...
            projectConversationCallMatcherPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/conversations/{conversation}/callMatchers/{call_matcher}'),
            ...
            projectLocationConversationCallMatcherPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/conversations/{conversation}/callMatchers/{call_matcher}'),
        ...
        this.descriptors.page = {
            ...
            listCallMatchers: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'callMatchers'),
     ...
     */
    createCallMatcher(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     */
    deleteCallMatcher(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listCallMatchers(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   for more details and examples.
     */
    listCallMatchersStream(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listCallMatchers.createStream(this.innerApiCalls.listCallMatchers, request, callSettings);
    }
    /**
     ...
     * }
     */
    listCallMatchersAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listCallMatchers.asyncIterate(this.innerApiCalls['listCallMatchers'], request, callSettings);
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    projectConversationCallMatcherPath(project, conversation, callMatcher) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectConversationCallMatcherName(projectConversationCallMatcherName) {
     ...
     * @returns {string} A string representing the conversation.
     */
    matchConversationFromProjectConversationCallMatcherName(projectConversationCallMatcherName) {
     ...
     */
    matchCallMatcherFromProjectConversationCallMatcherName(projectConversationCallMatcherName) {
     ...
     * @returns {string} Resource name string.
     */
    projectLocationConversationCallMatcherPath(project, location, conversation, callMatcher) {
     ...
     * @returns {string} A string representing the project.
     */
    matchProjectFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName) {
     ...
     * @returns {string} A string representing the location.
     */
    matchLocationFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName) {
     ...
     * @returns {string} A string representing the conversation.
     */
    matchConversationFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName) {
     ...
     * @returns {string} A string representing the call_matcher.
     */
    matchCallMatcherFromProjectLocationConversationCallMatcherName(projectLocationConversationCallMatcherName) {
