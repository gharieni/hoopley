...
export declare class ConversationsClient {
    ...
    createCallMatcher(request: protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.ICallMatcher, (protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest | undefined), {} | undefined]>;
    createCallMatcher(request: protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.v2beta1.ICallMatcher, protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    createCallMatcher(request: protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest, callback: Callback<protos.google.cloud.dialogflow.v2beta1.ICallMatcher, protos.google.cloud.dialogflow.v2beta1.ICreateCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    deleteCallMatcher(request: protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest, options?: CallOptions): Promise<[protos.google.protobuf.IEmpty, (protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest | undefined), {} | undefined]>;
    deleteCallMatcher(request: protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest, options: CallOptions, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    deleteCallMatcher(request: protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest, callback: Callback<protos.google.protobuf.IEmpty, protos.google.cloud.dialogflow.v2beta1.IDeleteCallMatcherRequest | null | undefined, {} | null | undefined>): void;
    ...
    listCallMatchers(request: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, options?: CallOptions): Promise<[protos.google.cloud.dialogflow.v2beta1.ICallMatcher[], protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest | null, protos.google.cloud.dialogflow.v2beta1.IListCallMatchersResponse]>;
    listCallMatchers(request: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, options: CallOptions, callback: PaginationCallback<protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, protos.google.cloud.dialogflow.v2beta1.IListCallMatchersResponse | null | undefined, protos.google.cloud.dialogflow.v2beta1.ICallMatcher>): void;
    listCallMatchers(request: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, callback: PaginationCallback<protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, protos.google.cloud.dialogflow.v2beta1.IListCallMatchersResponse | null | undefined, protos.google.cloud.dialogflow.v2beta1.ICallMatcher>): void;
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
     *   The request object that will be sent.
     ...
     *   for more details and examples.
     */
    listCallMatchersStream(request?: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, options?: CallOptions): Transform;
    /**
     ...
     * }
     */
    listCallMatchersAsync(request?: protos.google.cloud.dialogflow.v2beta1.IListCallMatchersRequest, options?: CallOptions): AsyncIterable<protos.google.cloud.dialogflow.v2beta1.ICallMatcher>;
